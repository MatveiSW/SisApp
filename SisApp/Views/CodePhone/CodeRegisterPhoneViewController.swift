...
class CodeRegisterPhoneViewController: UIViewController {
    
    private lazy var mainView = CodeRegisterPhoneView()
...
extension CodeRegisterPhoneViewController: CodeRegisterPhoneButtonDelegate {
...
extension CodeRegisterPhoneViewController: UITextFieldDelegate {
